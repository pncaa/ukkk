        ...
        <div class="md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/updatetransaksi/{{$dataTransaksi->id}}" method="POST">
                        ...
                        <form>
                            <div class="mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="namapelanggan" value="{{ $dataTransaksi->namacustomer }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1">Pengerjaan</label>
                                <select class="form-control" aria-label="Default select example" name="status" value="{{ $dataTransaksi->status }}">
